  ...
  <div class="min-h-screen bg-white">
    <div class="relative max-w-4xl mx-auto px-6 py-12">
      <header class="mb-10">
        ...
        <p class="font-semibold text-stone-400 mt-1">Customize your practice experience</p>
      </header>
      ...
      <section class="card px-6 py-6 mb-6">
        <div class="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 class="text-lg font-serif font-bold uppercase tracking-wide text-stone-800">Practice Schedule</h2>
            <p class="text-md font-semibold text-stone-500">How often and how much you want to practice</p>
          </div>
        </div>
      ...
      <section class="card px-6 py-6 mb-6 opacity-50">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h2 class="text-base font-serif font-bold uppercase tracking-wide text-stone-800">Preferences</h2>
            <p class="text-sm font-semibold text-stone-400">Coming soon</p>
          </div>
        </div>
      </section>
      ...
      <section class="card px-6 py-6 opacity-50">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h2 class="text-base font-serif font-bold uppercase tracking-wide text-stone-800">Account</h2>
            <p class="text-sm font-semibold text-stone-400">Coming soon</p>
          </div>
        </div>
      </section>
